...
if (params.env === 'prod'){
	...
	CKEDITOR.on( 'instanceCreated', function ( event ) {
      ...
      editor.on( 'focus', function( evt ) {
        ...
        editor.on( 'blur', function( evt ) {
          ...
          var htmlString = $("#updateSuccess").html();
        ...
        //Page Content
           ...
           var contentfileName = $(htmlString).find('id').prevObject[2].id;
           var contentThisContent = $(htmlString).find('id').prevObject[2].innerHTML;
        ...
        updateRecord(fileName,thisContent,"updateTitleandContent.cfm",contentfileName,contentThisContent);    
    ...
    function updateRecord(filename,content,actionUrl,thistitle,thiscontent){ 
        var myUrl = baseUrl + actionUrl; 
        $.post(myUrl, 
               { postTitle: filename, 
                 postContent: content,
                 contentTitle: thistitle,
                 contentContent: thiscontent
               }, 
               ...
               { 
                ...
                var isVisible = $( "#updateSuccess" ).is( ":visible" );
